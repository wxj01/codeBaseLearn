 ...
 * @date 2021/6/1 0001 15:15
 */
public class SingletonInnerClassesDemo {
    private static class SingletonHolder{
        private static SingletonInnerClassesDemo instance =  new SingletonInnerClassesDemo();
    }

    private SingletonInnerClassesDemo (){}
    public static SingletonInnerClassesDemo getInstance(){
