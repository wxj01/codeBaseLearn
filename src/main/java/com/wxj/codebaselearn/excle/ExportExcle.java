...
//			transformer.transformXLS(path,map,outFilePath);
    ...
    public static   void transformXLS(XLSTransformer transformer, InputStream is, Map beanParams, String destFilePath) throws ParsePropertyException, IOException, InvalidFormatException {
